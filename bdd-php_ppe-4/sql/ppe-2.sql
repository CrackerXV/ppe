...
--
-- Hôte : localhost:8889
-- Généré le : lun. 10 fév. 2025 à 10:49
...
(27, 39, '2025-02-03', '2026-02-03', 30),
(28, 28, '2025-02-03', '2025-03-03', 0);
...
(32, 2, 'Crime et Chatiment', 39, 'test trois', 3, '2025-02-03'),
(33, 2, 'Crime et Chatiment', 28, 'avis', 4, '2025-02-03');
...
(456, '2025-02-03', 'expédiée', '2025-02-10', 39),
(457, '2025-02-03', 'expédiée', '2025-02-10', 39),
(458, '2025-02-03', 'expédiée', '2025-02-10', 39),
(459, '2025-02-03', 'expédiée', '2025-02-10', 39),
(460, '2025-02-03', 'expédiée', '2025-02-10', 28),
(461, '2025-02-03', 'expédiée', '2025-02-10', 28);
...
(2, 'Crime et Chatiment', 'Dostoïevski', 'crime_et_chatiment.png', 87, 15.00, 1, 2),
(3, 'L`Etranger', 'Camus', 'l_etranger.png', 54, 10.00, 1, 3),
...
(39, 'trois@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'trois', 'trois', 'trois@gmail.com', '2025-02-03', 'F');
...
(1, 3, '2025-01-05', '2025-01-20', 8.00),
...
(39, 'trois@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'trois@gmail.com', 'client');
...
--
ALTER TABLE `abonnement`
  MODIFY `idAbonnement` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `commande`
  MODIFY `idCommande` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=462;
